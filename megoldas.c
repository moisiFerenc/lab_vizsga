...
// Tranzakció struktúra (láncolt lista)
...
// Tranzakció hozzáadása a listához
...
int main() {
    ...
    // Master ciklus: pipe olvasás és buffer feltöltés
    char buffer[256];
    size_t buffer_pos = 0;
